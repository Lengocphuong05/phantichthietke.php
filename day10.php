...
//Tạo một abstract class "Employee" (Nhân viên) với các thuộc tính trừu tượng như "name" (tên) và "salary" (mức lương). Tạo các lớp con "Manager" (Quản lý) và "Staff" (Nhân viên) kế thừa từ lớp Employee và triển khai các thuộc tính và phương thức theo cách riêng của từng lớp.
...
$less3_1 = new Manager("Mai", "100tr");
$less3_2 = new Staff("Hoa", "80tr");
...
class MySQLDatabase extends Database {
        ...
        public	function connect($host = "localhost", $user = "root", $pass = "", $dbname = "lesson8", $options = [])
        {
            $this->isConn = TRUE;
            try {
...
$less7_1 = new FileLogger("log1");
$less7_2 = new DatabaseLogger("log2");
